    ...
    <div v-else>
      ...
      >
       ...
       <div v-else-if="activeTab === 'transactions'" class="animate-fadeIn">
        <ModulesTransactionsList :pagination="transactionPagination" :loading="fetchingTransactions" :transactions="transactions" />
       </div>
...
const { transactions, loading: fetchingTransactions, pagination: transactionPagination } = useGetUserTransactions()
const {
...
// Replace the existing referral-related functions in your script with these enhanced versions
